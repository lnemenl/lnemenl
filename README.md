...
| Project | Overview |
|:---|:---|
| [**Online Multiplayer Game**](https://github.com/lnemenl/ft_transcendence) | **Full-Stack Architecture.** Real-time SPA featuring **JWT auth**, **Google OAuth2**, and **2FA**. Built with a high-performance **Fastify** backend and scalable **Prisma** database schema. |
